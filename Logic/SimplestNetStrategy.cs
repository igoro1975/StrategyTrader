...
using DataRequestClient;
using StrategyTrader;
...
namespace StrategyTrader.Logic
{
    internal class SimplestNetStrategy : IStrategy
    {
        ...
        private RequestsClient requestClient;
        ...
        private void GetInstrumentAndContract()
        {
            ...
            instrument = requestClient.RequestActiveInstrumentContract(settings.StrategyID);
            ...
            calendar = new TradingCalendar(instrument.ExpirationRule, instrument.Expiration, instrument.Sessions, instrument.Exchange.Timezone, settings.TradingOnBankingHoliday);
        }
