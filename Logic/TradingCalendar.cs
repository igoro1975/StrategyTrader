...
namespace StrategyTrader.Logic
{
    internal class TradingCalendar
    {
        ...
        private bool tradeOnBankingHolidays;

        public TradingCalendar(ExpirationRule expirationRule, DateTime expirationDate, ICollection<InstrumentSession> instrumentSessions, string exchangeTimezone, bool tradeOnBankingHolidays)
        {
            this.instrumentSessions = instrumentSessions;
            ExchangeTimeZone = exchangeTimezone;
            ExpirationRule = expirationRule;
            ExpirationDate = expirationDate;
            this.tradeOnBankingHolidays=tradeOnBankingHolidays;
